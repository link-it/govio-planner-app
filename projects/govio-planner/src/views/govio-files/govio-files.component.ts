...
@Component({
  selector: 'app-govio-files',
  templateUrl: 'govio-files.component.html',
  styleUrls: ['govio-files.component.scss']
})
export class GovioFilesComponent implements OnInit, AfterViewInit, AfterContentChecked, OnDestroy {
  static readonly Name = 'GovioFilesComponent';
  ...
  breadcrumbs: any[] = [
    { label: 'APP.TITLE.GovioFiles', url: '', type: 'title', icon: 'receipt' }
  ];
